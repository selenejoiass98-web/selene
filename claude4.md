...
- [ ] **PENDENTE (bloqueia o rastreio): criar env `FIREBASE_SERVICE_ACCOUNT` na Vercel** — Firebase Console → Configurações do projeto → Contas de serviço → Gerar nova chave privada → colar o JSON inteiro na Vercel (Settings → Environment Variables) e redeployar. Sem ela, /api/rastreio responde 503
